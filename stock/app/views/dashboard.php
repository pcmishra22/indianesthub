...
.ticker-bar{background:rgba(8,26,46,.45);border-bottom:1px solid var(--border);padding:6px 20px;font-size:11px;color:var(--muted);display:flex;gap:4px;align-items:center;overflow:hidden}
