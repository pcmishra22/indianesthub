...
<head>
	...
	<meta name="description" content="@yield('meta_description', 'Find the best residential and commercial properties in Tricity - Chandigarh, Mohali, Zirakpur & Panchkula.')">
	<meta name="author" content="IndianestHub">
	<meta name="keywords" content="@yield('meta_keywords', 'real estate, properties, flats in mohali, plots in zirakpur, buy house, rent apartment')">
              ...
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{ route('dealer.properties.index') }}">
							<i class="align-middle" data-feather="list"></i> <span class="align-middle">List Properties</span>
						</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{ route('dealer.inquiries.index') }}">
							<i class="align-middle" data-feather="list"></i> <span class="align-middle">Enquiries</span>
						</a>
					</li>
					<li class="sidebar-item">
