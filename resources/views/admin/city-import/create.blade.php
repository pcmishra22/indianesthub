...
<div class="container py-4" style="max-width: 640px;">
    ...
    <p class="text-muted small mt-4">
        Builders &amp; Agents use Mappls (MapmyIndia) if <code>MAPPLS_CLIENT_ID</code> and
        <code>MAPPLS_CLIENT_SECRET</code> are set in your <code>.env</code> — sign up free at
        <a href="https://www.mapmyindia.com/api/maps-api-free/" target="_blank" rel="noopener">mapmyindia.com/api/maps-api-free</a>
        (no credit card required). Mappls is an India-focused mapping company with much deeper coverage of Indian
        cities and towns than global providers. Without credentials, it automatically falls back to OpenStreetMap
        (free, no signup, but coverage varies more by city). Properties can't be auto-crawled from listing portals
        or search engines — that would violate their Terms of Service — so choose <strong>Property</strong> and
        upload a CSV instead. You'll still review and tick every row before anything is saved.
    </p>
</div>
@endsection
