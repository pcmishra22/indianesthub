<!-- Properties Items Partial: 6 property cards from properties.html -->
...
<!-- 5 more property cards below, copied from properties.html... -->
@include('frontend.partials.properties-items-static')
