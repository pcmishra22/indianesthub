					...
					<div class="row g-4 align-items-center">
						<div class="col-lg-6">
							<div class="primary-image-wrap">
								<img src="{{ asset('frontend/img/real-estate/property-exterior-4.webp') }}" alt="Luxury Property" class="img-fluid">
						...
						<div class="col-lg-6">
							<div class="secondary-image-wrap">
								<img src="{{ asset('frontend/img/real-estate/agent-3.webp') }}" alt="Professional Agent" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="testimonial-card">
						...
						<div class="testimonial-author">
							<div class="author-image">
								<img src="{{ asset('frontend/img/person/person-f-8.webp') }}" alt="Client" class="img-fluid">
							</div>
			...
			<div class="row justify-content-center text-center">
				<div class="col-lg-8">
					...
					<div class="action-buttons">
						<a href="{{ url('/contact') }}" class="btn btn-primary">Get Started Today</a>
