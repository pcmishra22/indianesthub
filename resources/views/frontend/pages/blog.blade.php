      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-4">
          <article>
            ...
            <div class="post-img">
              <img src="{{ asset('frontend/img/blog/blog-post-1.webp') }}" alt="" class="img-fluid">
            </div>
            ...
            <div class="d-flex align-items-center">
              <img src="{{ asset('frontend/img/person/person-f-12.webp') }}" alt="" class="img-fluid post-author-img flex-shrink-0">
              <div class="post-meta">
        ...
        <div class="col-lg-4">
          <article>
            ...
            <div class="post-img">
              <img src="{{ asset('frontend/img/blog/blog-post-2.webp') }}" alt="" class="img-fluid">
            </div>
            ...
            <div class="d-flex align-items-center">
              <img src="{{ asset('frontend/img/person/person-f-13.webp') }}" alt="" class="img-fluid post-author-img flex-shrink-0">
              <div class="post-meta">
        ...
        <div class="col-lg-4">
          <article>
            ...
            <div class="post-img">
              <img src="{{ asset('frontend/img/blog/blog-post-3.webp') }}" alt="" class="img-fluid">
            </div>
            ...
            <div class="d-flex align-items-center">
              <img src="{{ asset('frontend/img/person/person-m-10.webp') }}" alt="" class="img-fluid post-author-img flex-shrink-0">
              <div class="post-meta">
        ...
        <div class="col-lg-4">
          <article>
            ...
            <div class="post-img">
              <img src="{{ asset('frontend/img/blog/blog-post-4.webp') }}" alt="" class="img-fluid">
            </div>
            ...
            <div class="d-flex align-items-center">
              <img src="{{ asset('frontend/img/person/person-f-14.webp') }}" alt="" class="img-fluid post-author-img flex-shrink-0">
              <div class="post-meta">
        ...
        <div class="col-lg-4">
          <article>
            ...
            <div class="post-img">
              <img src="{{ asset('frontend/img/blog/blog-post-5.webp') }}" alt="" class="img-fluid">
            </div>
            ...
            <div class="d-flex align-items-center">
              <img src="{{ asset('frontend/img/person/person-m-11.webp') }}" alt="" class="img-fluid post-author-img flex-shrink-0">
              <div class="post-meta">
        ...
        <div class="col-lg-4">
          <article>
            ...
            <div class="post-img">
              <img src="{{ asset('frontend/img/blog/blog-post-6.webp') }}" alt="" class="img-fluid">
            </div>
            ...
            <div class="d-flex align-items-center">
              <img src="{{ asset('frontend/img/person/person-f-15.webp') }}" alt="" class="img-fluid post-author-img flex-shrink-0">
              <div class="post-meta">
