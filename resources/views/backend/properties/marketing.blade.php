            ...
            <div class="card h-100">
                <div class="card-body d-flex flex-column">
                    ...
                    <p class="card-text text-muted small flex-grow-1">
                        Auto-generate a branded PDF brochure from this property's photos, price, specs and contact details.
                    </p>
                    <a href="{{ route('admin.properties.marketing.brochure', $property->id) }}" class="btn btn-primary btn-sm">
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100">
                <div class="card-body d-flex flex-column">
                    ...
                    <p class="card-text text-muted small flex-grow-1">
                        Share a quick message with this property's link on WhatsApp.
                    </p>
                    @if($publicUrl)
                        @php
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100">
                <div class="card-body d-flex flex-column">
                    ...
                    <p class="card-text text-muted small flex-grow-1">
                        Auto-generate an Instagram/Facebook-ready post image with caption, or share the link directly to Facebook, X, LinkedIn or WhatsApp.
                    </p>
                    <a href="{{ route('admin.properties.marketing.social-post', $property->id) }}" class="btn btn-primary btn-sm">
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100">
                <div class="card-body d-flex flex-column">
                    ...
                    <p class="card-text text-muted small flex-grow-1">
                        Send a designed email campaign for this property to everyone who enquired, plus any extra addresses.
                    </p>
                    <a href="{{ route('admin.properties.marketing.edm', $property->id) }}" class="btn btn-primary btn-sm">
