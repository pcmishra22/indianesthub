...
@section('title', 'Dealer Bulk Email')

@section('content')
<div class="container-fluid p-0">
    <h1 class="h3 mb-3"><strong>Dealer Bulk Email</strong></h1>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.dealers.bulk-email.store') }}">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <div class="text-muted small mt-1">
                        Emails will be queued asynchronously to all <strong>active</strong> dealers.
                    </div>
                    @error('body')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
